...
export const environment = {
  ...
  oidc: {
    ...
    redirectUri: window.location.origin + '/TalentManagement-Client-Angular15',
    postLogoutRedirectUri: window.location.origin + '/TalentManagement-Client-Angular15',
    silentRefreshRedirectUri: window.location.origin + '/TalentManagement-Client-Angular15/silent-refresh.html',
